import{products as products}from"../database/products.js";export default class ProductsList{constructor(){this.productsList=document.getElementById("products-tabs"),this.tabsMenu=document.getElementById("tabs-menu"),this.initList()}initList(){this.productsList.innerHTML=null,this.tabsMenu.innerHTML=null,this.productsList.innerHTML+=this.renderProductsTabs(),this.tabsMenu.innerHTML+=this.renderTabsMenu()}renderTabsMenu(){let a="";return products.forEach((t,s)=>{a+=`<li class="tabs__menu-item">
                    ...
                    <a href="http://127.0.0.1:5500/product.html?product=${t.id}" class="card card--product-import">
                        <div class="card__image-wrapper">
                            ...
                            <div class="card__badge">
                                ...
                                <span class="card__badge-count">${t.images.length}</span>
                            </div>
                        </div>
                        <div class="card__column">
                            <h2 class="card__title">${t.name}</h2>
                            <h3 class="card__model">${t.model}</h3>
                            <ul class="card__feature">
                                <li class="card__feature-item">${t.features[0].value}</li>
                                <li class="card__feature-item">${t.features[1].value} (KM)</li>
                                <li class="card__feature-item">${t.features[2].value} (CC)</li>
                                <li class="card__feature-item">${t.features[3].value} (OMV)</li>
                            </ul>
                            <div class="card__row">
                                <div class="card__row-inner">
                                    <div class="card__price">${t.price}</div>
                                    <div class="card__info">Inclusive of COE</div>
                                </div>
                                <div class="card__row-inner">
                                    <div class="card__text">${t.exterior}</div>
                            ...
                            <div class="card__row card__row--mt">
                                ...
                                <div class="card__row-inner">
                                    <div class="card__text">${t.interior}</div>
                                    <div class="card__info">Interior</div>
                                </div>
                            </div>
                        </div>
                    </a>
                </li>`}),s}renderMenu(){return""}}new ProductsList;